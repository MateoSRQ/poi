...
function Component() {
    ...
    useEffect(() => {
        ...
        const readData = async () => {
            let response = await axios.post('https://prjboss.uap.edu.pe:8443/poiuappruebaback/api/poi/listar-actividades', {
                dato: {
                    idusuario: 1
                }
            })
    ...
    for (let i=0; i<2; i++) {
        emptyItems.push(
            <Card
                ...
                //         alt="example"
                //         src="assets/pdf.jpg"
                //         style={{width: '40%', margin: '0 auto', transform: 'rotate(6deg)', paddingTop: '30px', filter: 'grayscale(100%)'}}
                //     />
                // }
            >
                <Form
                ...
                <Drawer placement="right" onClose={onClose} visible={visible} closeIcon={null}>
                    ...
                    >
                        ...
                        <Row gutter={16} align="middle" justify="center" style={{marginTop: '30px'}} >
                            ...
                            <Col className="gutter-row" span={8}>
                                    <CheckCircleOutlined  key = "no" style={{ fontSize: '24px', color: '#d50000' }}/>
                            </Col>
                            <Col className="gutter-row" span={8}>
                                    <SearchOutlined key = "no" style={{ fontSize: '24px', color: '#08c' }}/>
                            </Col>
                        </Row>
